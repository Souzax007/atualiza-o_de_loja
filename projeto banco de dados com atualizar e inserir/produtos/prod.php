...
$sql = "SELECT p.id_produto, c.nm_categoria, m.nm_marca, p.nm_produto, p.ds_descricao, p.vl_valor, p.nr_estoque
        FROM produtos p
        LEFT JOIN categorias c ON p.id_categoria = c.id_categoria
        LEFT JOIN marcas m ON p.id_marca = m.id_marca $search LIMIT $offset, $registros_por_pagina";
...
<body>
    ...
    <div id="loading">
        <img src="https://cdn.dribbble.com/users/516449/screenshots/2917399/media/fb0cac6cab5b785793ffe08e68e16b42.gif" alt="">
    </div>
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    //MONTAR SQL PARA BUSCAR OS TAMANHOS DE CADA PRODUTO
                    $sql_tam = "SELECT pt.id_tamanho, t.nm_tam
                    FROM prod_tam pt
                    LEFT JOIN tamanhos t ON t.id_tam = pt.id_tamanho
